...
For the surface-level analysis, the spaCy package was used (\texttt{sv\_core\_news\_sm}) to collect distributions of: vocabulary distribution, part-of-speech distribution,
\subsection{Content-level analysis}
\subsection{Textual analysis experimental set-up}

\section{LLM-generated text detection}
...
Two types of textual analysis – linguistic (surface-level) and informational (sentiment analysis + narrative structure) 

AI Human detection web app – quantitative measure (accuracy), qualitative measure (reasons for why choice) 
