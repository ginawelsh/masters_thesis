...
\subsection{Human-written data}

\subsubsection{FOrmal  data}
...
The informal dataset comprised of (~200+?) Swedish-language Reddit questions and comments from (insert subreddits) and (insert number) comment threads. The question set was taken from before 2017 (using ArcticShift API) 
