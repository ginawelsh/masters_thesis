...
The underlying architecture of LLMs, that is, the Transformer architecture, was first described in \textcite{vaswani2017attention}. In this study, the authors designed an encoder-decoder sequence transduction model to create a network architecture that demonstrated superior performance and decreased training time in comparison to its recurrent neural network predecessors. 
\paragraph{}
