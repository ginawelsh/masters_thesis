...
# paths: same structure as OpenAI script
csv_path = os.path.join(_root, "src", "data_collection", "sv_data_collection_csv.csv")
out_csv_path = os.path.join(_root, "src", "data_collection", "sv_abstracts_gemini.csv")
...
if __name__ == "__main__":
    ...
    data_csv["Generated_Gemini_Abstract"] = pd.NA
